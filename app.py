...
def check_smoothed_ha(df, len1=10, len2=10):
    ...
    # Step 2: Build Heikin-Ashi Values
...
if st.button("🚀 Start Scanning Market"):
    ...
    symbols = [item['symbol'] for item in ticker_res['result']['list'] if item['symbol'].endswith('USDT')]
